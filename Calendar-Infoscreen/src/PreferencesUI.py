...
class Ui_Preferences_Window(object):
    def setupUi(self, Preferences_Window):
        ...
        Preferences_Window.resize(520, 304)
        ...
        self.gridLayout.addWidget(self.spinInterval, 0, 6, 1, 1)
        self.lblMinutes = QtWidgets.QLabel(self.groupBox_2)
        self.lblMinutes.setObjectName("lblMinutes")
        self.gridLayout.addWidget(self.lblMinutes, 0, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.chkSSL, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.linePort, 1, 6, 1, 1)
    ...
    def retranslateUi(self, Preferences_Window):
        ...
        self.label_2.setText(_translate("Preferences_Window", "HTTP Server Port:"))
